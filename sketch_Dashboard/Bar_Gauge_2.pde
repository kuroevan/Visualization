...
class Bar2 extends Bar
{
  ...
  Bar2 (int iposX, int iposY, int iSize, int rangeLow, int rangeHigh, String ilabel)
  {
    super(iposX, iposY, iSize, rangeLow, rangeHigh, ilabel);
    size = iSize;
    posX = iposX;
    posY = iposY;
    label = ilabel;
  ...
  void textdisp () {
    println("Inside Bar Gauge 2 subclass");
  }
